...
## Rental Process
1. **Request**: Specify the amount of Energy and the duration.
2. **Payment**: Pay the rental fee in TRX.
3. **Receipt**: Energy is delegated to your address for the specified duration.
